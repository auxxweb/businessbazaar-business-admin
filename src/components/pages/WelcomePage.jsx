...
export default function WelcomePage() {
    const { welcomePart } = useSelector((state) => state.business.data);
  
    // Local state to manage input fields
    const [title, setTitle] = useState(welcomePart.title);
    const [description, setDescription] = useState(welcomePart.description);
    const [image, setImage] = useState(welcomePart.coverImage);
    const [imagePreview, setImagePreview] = useState(welcomePart.coverImage);
    ...
    useEffect(() => {
      // Update image preview when welcomePart.coverImage changes
      setImagePreview(welcomePart.coverImage);
