        ...
        <div className=" block md:flex  bg-transparent relative">
          ...
          <div className="ml-6  px-2">
            ...
            <div className="flex items-center gap-3 ">
              ...
              {!socialLinks?.twitter && (
                <a className="cursor-pointer" href={socialLinks?.twitter}>
                  <svg
                    className="w-10 h-10 "
			...
			z"
              ...
              {!socialLinks?.facebook && (
                <a className="cursor-pointer" href={socialLinks?.facebook}>
                  <svg
                    className="w-8 h-8 "
                    fill="#000000"
                    width="30px"
              ...
              {!socialLinks?.instagram && (
                <a className="cursor-pointer" href={socialLinks?.instagram}>
                  <svg
                    width="27px"
                    height="27px"
                    viewBox="0 0 24 24"
